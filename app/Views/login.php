    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form class="login" id="login_frm" action="<?php echo base_url(); ?>home/loginSubmit" method="POST" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo base_url(); ?>home/signup" class="button login__submit">
